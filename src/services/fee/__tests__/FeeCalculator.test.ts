...
describe('FeeCalculator', () => {
    ...
    describe('checkGracePeriod', () => {
        ...
        it('should return false if the time difference is more than the grace period', () => {
            const startTime = "10:00";
            const endTime = "10:16";
            expect(feeCalculator.checkGracePeriod(startTime, endTime, 15)).toBe(false);
        });
    });
    ...
    describe('calcaulateDays', () => {
        it('should return 3 days if the start and end time are 3 days apart', () => {
            ...
            const expectedResult = [
                {dayStartTime: LocalTime.parse("10:00"), dayEndTime: LocalTime.parse("23:59"), isWeekendOrPH: false},
                {dayStartTime: LocalTime.parse("00:00"), dayEndTime: LocalTime.parse("23:59"), isWeekendOrPH: true},
                {dayStartTime: LocalTime.parse("00:00"), dayEndTime: LocalTime.parse("11:00"), isWeekendOrPH: true},
            ]
            expect(feeCalculator.calculateDays(startTime, endTime)).toStrictEqual(expectedResult);
        });
        ...
        it('should return 1 day if the start and end time are on the same day', () => {
            ...
            const expectedResult = [
                {dayStartTime: LocalTime.of(10,0,0), dayEndTime: LocalTime.of(11,0,0), isWeekendOrPH: true},
            ]
