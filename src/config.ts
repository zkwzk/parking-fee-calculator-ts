...
const orchardCentralWeekday0to1759: FixedFirstXMinutes = new FixedFirstXMinutes(
  "00:00",
  "17:59",
  60,
  2.73,
...
const orchardCentralWeekday18to2359: FixedFeePerEntry = new FixedFeePerEntry(
  "18:00",
  "23:59",
  4.09
);

const orchardCentralWeekendPH0to1759: FixedFirstXMinutes =
  new FixedFirstXMinutes("00:00", "17:59", 60, 2.94, 15, 0.74);
const orchardCentralWeekendPH18to2359: FixedFeePerEntry = new FixedFeePerEntry(
  "18:00",
  "23:59",
  4.41
);
...
const tscWeekday0to1159: FixedFeePerXMinutes = new FixedFeePerXMinutes(
  "00:00",
  "11:59",
  30,
  1.31
);
const tscWeekday12to1359: FixedFeePerXMinutes = new FixedFeePerXMinutes(
  "12:00",
  "13:59",
  30,
  1.85
);
const tscWeekday14to1659: FixedFeePerXMinutes = new FixedFeePerXMinutes(
  "14:00",
  "16:59",
  30,
  1.31
);
const tscWeekday17to1859: FixedFeePerXMinutes = new FixedFeePerXMinutes(
  "17:00",
  "18:59",
  30,
  1.85
);
const tscWeekday19to2359: FixedFeePerEntry = new FixedFeePerEntry(
  "19:00",
  "23:59",
  4.36
);

const tscWeekendPH0to1159: FixedFirstXMinutes = new FixedFirstXMinutes(
  "00:00",
  "11:59",
  60,
  2.62,
...
const tscWeekendPH12to1359: FixedFirstXMinutes = new FixedFirstXMinutes(
  "12:00",
  "13:59",
  60,
  3.71,
...
const tscWeekendPH14to1659: FixedFirstXMinutes = new FixedFirstXMinutes(
  "14:00",
  "16:59",
  60,
  2.62,
...
const tscWeekendPH17to1859: FixedFirstXMinutes = new FixedFirstXMinutes(
  "17:00",
  "18:59",
  60,
  3.71,
...
const tscWeekendPH19to2359: FixedFeePerEntry = new FixedFeePerEntry(
  "19:00",
  "23:59",
  4.36
);
...
export const carParkList = Array.of(
